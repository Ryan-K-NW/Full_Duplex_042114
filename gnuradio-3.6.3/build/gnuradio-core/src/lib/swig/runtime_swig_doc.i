...
%feature("docstring") gr_hier_block2::msg_connect "Add gr-blocks or hierarchical blocks to internal graph and wire together.
...
%feature("docstring") gr_block::max_noutput_items "Return the maximum number of output items this block will handle during a call to work."

%feature("docstring") gr_block::set_max_noutput_items "Set the maximum number of ouput items htis block will handle during a call to work."

%feature("docstring") gr_block::unset_max_noutput_items "Clear the switch for using the max_noutput_items value of this block.
...
%feature("docstring") gr_block::is_set_max_noutput_items "Ask the block if the flag is or is not set to use the internal value of max_noutput_items during a call to work."



%feature("docstring") gr_block::max_output_buffer "Returns max buffer size on output port ."

%feature("docstring") gr_block::set_max_output_buffer "Sets max buffer size on all output ports."

%feature("docstring") gr_block::min_output_buffer "Returns min buffer size on output port ."

%feature("docstring") gr_block::set_min_output_buffer "Sets min buffer size on all output ports."
