...
class gr_basic_block_sptr(object):
    ...
    def symbol_name(self):
        ...
        return _gnuradio_core_runtime.gr_basic_block_sptr_symbol_name(self)
    ...
    def alias(self):
        """alias(self) -> string"""
        return _gnuradio_core_runtime.gr_basic_block_sptr_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(self, string name)"""
        return _gnuradio_core_runtime.gr_basic_block_sptr_set_block_alias(self, *args, **kwargs)
    ...
    def _post(self, *args, **kwargs):
        ...
        """
        return _gnuradio_core_runtime.gr_basic_block_sptr__post(self, *args, **kwargs)
    ...
    def message_ports_in(self):
        ...
        """
        return _gnuradio_core_runtime.gr_basic_block_sptr_message_ports_in(self)
    ...
    def message_ports_out(self):
        ...
        """
        return _gnuradio_core_runtime.gr_basic_block_sptr_message_ports_out(self)
...
class swig_int_ptr(object):
    ...
    def __init__(self): 
        ...
        this = _gnuradio_core_runtime.new_swig_int_ptr()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _gnuradio_core_runtime.delete_swig_int_ptr
    __del__ = lambda self : None;
swig_int_ptr_swigregister = _gnuradio_core_runtime.swig_int_ptr_swigregister
swig_int_ptr_swigregister(swig_int_ptr)


def pmt_is_bool(*args, **kwargs):
  """pmt_is_bool(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_bool(*args, **kwargs)

def pmt_is_true(*args, **kwargs):
  """pmt_is_true(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_true(*args, **kwargs)

def pmt_is_false(*args, **kwargs):
  """pmt_is_false(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_false(*args, **kwargs)

def pmt_from_bool(*args, **kwargs):
  """pmt_from_bool(bool val) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_from_bool(*args, **kwargs)

def pmt_to_bool(*args, **kwargs):
  """pmt_to_bool(pmt_t val) -> bool"""
  return _gnuradio_core_runtime.pmt_to_bool(*args, **kwargs)

def pmt_is_symbol(*args, **kwargs):
  """pmt_is_symbol(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_symbol(*args, **kwargs)

def pmt_string_to_symbol(*args, **kwargs):
  """pmt_string_to_symbol(string s) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_string_to_symbol(*args, **kwargs)

def pmt_intern(*args, **kwargs):
  """pmt_intern(string s) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_intern(*args, **kwargs)

def pmt_symbol_to_string(*args, **kwargs):
  """pmt_symbol_to_string(pmt_t sym) -> string"""
  return _gnuradio_core_runtime.pmt_symbol_to_string(*args, **kwargs)

def pmt_is_number(*args, **kwargs):
  """pmt_is_number(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_number(*args, **kwargs)

def pmt_is_integer(*args, **kwargs):
  """pmt_is_integer(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_integer(*args, **kwargs)

def pmt_from_long(*args, **kwargs):
  """pmt_from_long(long x) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_from_long(*args, **kwargs)

def pmt_to_long(*args, **kwargs):
  """pmt_to_long(pmt_t x) -> long"""
  return _gnuradio_core_runtime.pmt_to_long(*args, **kwargs)

def pmt_is_uint64(*args, **kwargs):
  """pmt_is_uint64(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_uint64(*args, **kwargs)

def pmt_from_uint64(*args, **kwargs):
  """pmt_from_uint64(uint64_t x) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_from_uint64(*args, **kwargs)

def pmt_to_uint64(*args, **kwargs):
  """pmt_to_uint64(pmt_t x) -> uint64_t"""
  return _gnuradio_core_runtime.pmt_to_uint64(*args, **kwargs)

def pmt_is_real(*args, **kwargs):
  """pmt_is_real(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_real(*args, **kwargs)

def pmt_from_double(*args, **kwargs):
  """pmt_from_double(double x) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_from_double(*args, **kwargs)

def pmt_to_double(*args, **kwargs):
  """pmt_to_double(pmt_t x) -> double"""
  return _gnuradio_core_runtime.pmt_to_double(*args, **kwargs)

def pmt_is_complex(*args, **kwargs):
  """pmt_is_complex(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_complex(*args, **kwargs)

def pmt_make_rectangular(*args, **kwargs):
  """pmt_make_rectangular(double re, double im) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_rectangular(*args, **kwargs)

def pmt_from_complex(*args, **kwargs):
  """pmt_from_complex(std::complex<(double)> z) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_from_complex(*args, **kwargs)

def pmt_to_complex(*args, **kwargs):
  """pmt_to_complex(pmt_t z) -> std::complex<(double)>"""
  return _gnuradio_core_runtime.pmt_to_complex(*args, **kwargs)

def pmt_is_null(*args, **kwargs):
  """pmt_is_null(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_null(*args, **kwargs)

def pmt_is_pair(*args, **kwargs):
  """pmt_is_pair(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_pair(*args, **kwargs)

def pmt_cons(*args, **kwargs):
  """pmt_cons(pmt_t x, pmt_t y) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cons(*args, **kwargs)

def pmt_car(*args, **kwargs):
  """pmt_car(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_car(*args, **kwargs)

def pmt_cdr(*args, **kwargs):
  """pmt_cdr(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cdr(*args, **kwargs)

def pmt_set_car(*args, **kwargs):
  """pmt_set_car(pmt_t pair, pmt_t value)"""
  return _gnuradio_core_runtime.pmt_set_car(*args, **kwargs)

def pmt_set_cdr(*args, **kwargs):
  """pmt_set_cdr(pmt_t pair, pmt_t value)"""
  return _gnuradio_core_runtime.pmt_set_cdr(*args, **kwargs)

def pmt_caar(*args, **kwargs):
  """pmt_caar(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_caar(*args, **kwargs)

def pmt_cadr(*args, **kwargs):
  """pmt_cadr(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cadr(*args, **kwargs)

def pmt_cdar(*args, **kwargs):
  """pmt_cdar(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cdar(*args, **kwargs)

def pmt_cddr(*args, **kwargs):
  """pmt_cddr(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cddr(*args, **kwargs)

def pmt_caddr(*args, **kwargs):
  """pmt_caddr(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_caddr(*args, **kwargs)

def pmt_cadddr(*args, **kwargs):
  """pmt_cadddr(pmt_t pair) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_cadddr(*args, **kwargs)

def pmt_is_tuple(*args, **kwargs):
  """pmt_is_tuple(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_tuple(*args, **kwargs)

def pmt_to_tuple(*args, **kwargs):
  """pmt_to_tuple(pmt_t x) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_to_tuple(*args, **kwargs)

def pmt_tuple_ref(*args, **kwargs):
  """pmt_tuple_ref(pmt_t tuple, size_t k) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_tuple_ref(*args, **kwargs)

def pmt_is_vector(*args, **kwargs):
  """pmt_is_vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_vector(*args, **kwargs)

def pmt_make_vector(*args, **kwargs):
  """pmt_make_vector(size_t k, pmt_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_vector(*args, **kwargs)

def pmt_vector_ref(*args, **kwargs):
  """pmt_vector_ref(pmt_t vector, size_t k) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_vector_ref(*args, **kwargs)

def pmt_vector_set(*args, **kwargs):
  """pmt_vector_set(pmt_t vector, size_t k, pmt_t obj)"""
  return _gnuradio_core_runtime.pmt_vector_set(*args, **kwargs)

def pmt_vector_fill(*args, **kwargs):
  """pmt_vector_fill(pmt_t vector, pmt_t fill)"""
  return _gnuradio_core_runtime.pmt_vector_fill(*args, **kwargs)

def pmt_is_blob(*args, **kwargs):
  """pmt_is_blob(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_blob(*args, **kwargs)

def pmt_make_blob(*args, **kwargs):
  """pmt_make_blob(void buf, size_t len) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_blob(*args, **kwargs)

def pmt_blob_data(*args, **kwargs):
  """pmt_blob_data(pmt_t blob) -> void"""
  return _gnuradio_core_runtime.pmt_blob_data(*args, **kwargs)

def pmt_blob_length(*args, **kwargs):
  """pmt_blob_length(pmt_t blob) -> size_t"""
  return _gnuradio_core_runtime.pmt_blob_length(*args, **kwargs)

def pmt_is_uniform_vector(*args, **kwargs):
  """pmt_is_uniform_vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_uniform_vector(*args, **kwargs)

def pmt_is_u8vector(*args, **kwargs):
  """pmt_is_u8vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_u8vector(*args, **kwargs)

def pmt_is_s8vector(*args, **kwargs):
  """pmt_is_s8vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_s8vector(*args, **kwargs)

def pmt_is_u16vector(*args, **kwargs):
  """pmt_is_u16vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_u16vector(*args, **kwargs)

def pmt_is_s16vector(*args, **kwargs):
  """pmt_is_s16vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_s16vector(*args, **kwargs)

def pmt_is_u32vector(*args, **kwargs):
  """pmt_is_u32vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_u32vector(*args, **kwargs)

def pmt_is_s32vector(*args, **kwargs):
  """pmt_is_s32vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_s32vector(*args, **kwargs)

def pmt_is_u64vector(*args, **kwargs):
  """pmt_is_u64vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_u64vector(*args, **kwargs)

def pmt_is_s64vector(*args, **kwargs):
  """pmt_is_s64vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_s64vector(*args, **kwargs)

def pmt_is_f32vector(*args, **kwargs):
  """pmt_is_f32vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_f32vector(*args, **kwargs)

def pmt_is_f64vector(*args, **kwargs):
  """pmt_is_f64vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_f64vector(*args, **kwargs)

def pmt_is_c32vector(*args, **kwargs):
  """pmt_is_c32vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_c32vector(*args, **kwargs)

def pmt_is_c64vector(*args, **kwargs):
  """pmt_is_c64vector(pmt_t x) -> bool"""
  return _gnuradio_core_runtime.pmt_is_c64vector(*args, **kwargs)

def pmt_make_u8vector(*args, **kwargs):
  """pmt_make_u8vector(size_t k, uint8_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_u8vector(*args, **kwargs)

def pmt_make_s8vector(*args, **kwargs):
  """pmt_make_s8vector(size_t k, int8_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_s8vector(*args, **kwargs)

def pmt_make_u16vector(*args, **kwargs):
  """pmt_make_u16vector(size_t k, uint16_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_u16vector(*args, **kwargs)

def pmt_make_s16vector(*args, **kwargs):
  """pmt_make_s16vector(size_t k, int16_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_s16vector(*args, **kwargs)

def pmt_make_u32vector(*args, **kwargs):
  """pmt_make_u32vector(size_t k, uint32_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_u32vector(*args, **kwargs)

def pmt_make_s32vector(*args, **kwargs):
  """pmt_make_s32vector(size_t k, int32_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_s32vector(*args, **kwargs)

def pmt_make_u64vector(*args, **kwargs):
  """pmt_make_u64vector(size_t k, uint64_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_u64vector(*args, **kwargs)

def pmt_make_s64vector(*args, **kwargs):
  """pmt_make_s64vector(size_t k, int64_t fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_s64vector(*args, **kwargs)

def pmt_make_f32vector(*args, **kwargs):
  """pmt_make_f32vector(size_t k, float fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_f32vector(*args, **kwargs)

def pmt_make_f64vector(*args, **kwargs):
  """pmt_make_f64vector(size_t k, double fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_f64vector(*args, **kwargs)

def pmt_make_c32vector(*args, **kwargs):
  """pmt_make_c32vector(size_t k, std::complex<(float)> fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_c32vector(*args, **kwargs)

def pmt_make_c64vector(*args, **kwargs):
  """pmt_make_c64vector(size_t k, std::complex<(double)> fill) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_c64vector(*args, **kwargs)

def pmt_init_u8vector(*args, **kwargs):
  """pmt_init_u8vector(size_t k, __dummy_15__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_u8vector(*args, **kwargs)

def pmt_init_s8vector(*args, **kwargs):
  """pmt_init_s8vector(size_t k, __dummy_17__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_s8vector(*args, **kwargs)

def pmt_init_u16vector(*args, **kwargs):
  """pmt_init_u16vector(size_t k, __dummy_19__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_u16vector(*args, **kwargs)

def pmt_init_s16vector(*args, **kwargs):
  """pmt_init_s16vector(size_t k, __dummy_20__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_s16vector(*args, **kwargs)

def pmt_init_u32vector(*args, **kwargs):
  """pmt_init_u32vector(size_t k, __dummy_23__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_u32vector(*args, **kwargs)

def pmt_init_s32vector(*args, **kwargs):
  """pmt_init_s32vector(size_t k, __dummy_22__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_s32vector(*args, **kwargs)

def pmt_init_f32vector(*args, **kwargs):
  """pmt_init_f32vector(size_t k, __dummy_4__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_f32vector(*args, **kwargs)

def pmt_init_f64vector(*args, **kwargs):
  """pmt_init_f64vector(size_t k, __dummy_5__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_f64vector(*args, **kwargs)

def pmt_init_c32vector(*args, **kwargs):
  """pmt_init_c32vector(size_t k, __dummy_6__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_c32vector(*args, **kwargs)

def pmt_init_c64vector(*args, **kwargs):
  """pmt_init_c64vector(size_t k, __dummy_27__ data) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_init_c64vector(*args, **kwargs)

def pmt_u8vector_ref(*args, **kwargs):
  """pmt_u8vector_ref(pmt_t v, size_t k) -> uint8_t"""
  return _gnuradio_core_runtime.pmt_u8vector_ref(*args, **kwargs)

def pmt_s8vector_ref(*args, **kwargs):
  """pmt_s8vector_ref(pmt_t v, size_t k) -> int8_t"""
  return _gnuradio_core_runtime.pmt_s8vector_ref(*args, **kwargs)

def pmt_u16vector_ref(*args, **kwargs):
  """pmt_u16vector_ref(pmt_t v, size_t k) -> uint16_t"""
  return _gnuradio_core_runtime.pmt_u16vector_ref(*args, **kwargs)

def pmt_s16vector_ref(*args, **kwargs):
  """pmt_s16vector_ref(pmt_t v, size_t k) -> int16_t"""
  return _gnuradio_core_runtime.pmt_s16vector_ref(*args, **kwargs)

def pmt_u32vector_ref(*args, **kwargs):
  """pmt_u32vector_ref(pmt_t v, size_t k) -> uint32_t"""
  return _gnuradio_core_runtime.pmt_u32vector_ref(*args, **kwargs)

def pmt_s32vector_ref(*args, **kwargs):
  """pmt_s32vector_ref(pmt_t v, size_t k) -> int32_t"""
  return _gnuradio_core_runtime.pmt_s32vector_ref(*args, **kwargs)

def pmt_u64vector_ref(*args, **kwargs):
  """pmt_u64vector_ref(pmt_t v, size_t k) -> uint64_t"""
  return _gnuradio_core_runtime.pmt_u64vector_ref(*args, **kwargs)

def pmt_s64vector_ref(*args, **kwargs):
  """pmt_s64vector_ref(pmt_t v, size_t k) -> int64_t"""
  return _gnuradio_core_runtime.pmt_s64vector_ref(*args, **kwargs)

def pmt_f32vector_ref(*args, **kwargs):
  """pmt_f32vector_ref(pmt_t v, size_t k) -> float"""
  return _gnuradio_core_runtime.pmt_f32vector_ref(*args, **kwargs)

def pmt_f64vector_ref(*args, **kwargs):
  """pmt_f64vector_ref(pmt_t v, size_t k) -> double"""
  return _gnuradio_core_runtime.pmt_f64vector_ref(*args, **kwargs)

def pmt_c32vector_ref(*args, **kwargs):
  """pmt_c32vector_ref(pmt_t v, size_t k) -> std::complex<(float)>"""
  return _gnuradio_core_runtime.pmt_c32vector_ref(*args, **kwargs)

def pmt_c64vector_ref(*args, **kwargs):
  """pmt_c64vector_ref(pmt_t v, size_t k) -> std::complex<(double)>"""
  return _gnuradio_core_runtime.pmt_c64vector_ref(*args, **kwargs)

def pmt_u8vector_set(*args, **kwargs):
  """pmt_u8vector_set(pmt_t v, size_t k, uint8_t x)"""
  return _gnuradio_core_runtime.pmt_u8vector_set(*args, **kwargs)

def pmt_s8vector_set(*args, **kwargs):
  """pmt_s8vector_set(pmt_t v, size_t k, int8_t x)"""
  return _gnuradio_core_runtime.pmt_s8vector_set(*args, **kwargs)

def pmt_u16vector_set(*args, **kwargs):
  """pmt_u16vector_set(pmt_t v, size_t k, uint16_t x)"""
  return _gnuradio_core_runtime.pmt_u16vector_set(*args, **kwargs)

def pmt_s16vector_set(*args, **kwargs):
  """pmt_s16vector_set(pmt_t v, size_t k, int16_t x)"""
  return _gnuradio_core_runtime.pmt_s16vector_set(*args, **kwargs)

def pmt_u32vector_set(*args, **kwargs):
  """pmt_u32vector_set(pmt_t v, size_t k, uint32_t x)"""
  return _gnuradio_core_runtime.pmt_u32vector_set(*args, **kwargs)

def pmt_s32vector_set(*args, **kwargs):
  """pmt_s32vector_set(pmt_t v, size_t k, int32_t x)"""
  return _gnuradio_core_runtime.pmt_s32vector_set(*args, **kwargs)

def pmt_u64vector_set(*args, **kwargs):
  """pmt_u64vector_set(pmt_t v, size_t k, uint64_t x)"""
  return _gnuradio_core_runtime.pmt_u64vector_set(*args, **kwargs)

def pmt_s64vector_set(*args, **kwargs):
  """pmt_s64vector_set(pmt_t v, size_t k, int64_t x)"""
  return _gnuradio_core_runtime.pmt_s64vector_set(*args, **kwargs)

def pmt_f32vector_set(*args, **kwargs):
  """pmt_f32vector_set(pmt_t v, size_t k, float x)"""
  return _gnuradio_core_runtime.pmt_f32vector_set(*args, **kwargs)

def pmt_f64vector_set(*args, **kwargs):
  """pmt_f64vector_set(pmt_t v, size_t k, double x)"""
  return _gnuradio_core_runtime.pmt_f64vector_set(*args, **kwargs)

def pmt_c32vector_set(*args, **kwargs):
  """pmt_c32vector_set(pmt_t v, size_t k, std::complex<(float)> x)"""
  return _gnuradio_core_runtime.pmt_c32vector_set(*args, **kwargs)

def pmt_c64vector_set(*args, **kwargs):
  """pmt_c64vector_set(pmt_t v, size_t k, std::complex<(double)> x)"""
  return _gnuradio_core_runtime.pmt_c64vector_set(*args, **kwargs)

def pmt_uniform_vector_elements(*args, **kwargs):
  """pmt_uniform_vector_elements(pmt_t v, size_t len) -> void"""
  return _gnuradio_core_runtime.pmt_uniform_vector_elements(*args, **kwargs)

def pmt_u8vector_elements(*args, **kwargs):
  """pmt_u8vector_elements(pmt_t v) -> __dummy_15__"""
  return _gnuradio_core_runtime.pmt_u8vector_elements(*args, **kwargs)

def pmt_s8vector_elements(*args, **kwargs):
  """pmt_s8vector_elements(pmt_t v) -> __dummy_17__"""
  return _gnuradio_core_runtime.pmt_s8vector_elements(*args, **kwargs)

def pmt_u16vector_elements(*args, **kwargs):
  """pmt_u16vector_elements(pmt_t v) -> __dummy_19__"""
  return _gnuradio_core_runtime.pmt_u16vector_elements(*args, **kwargs)

def pmt_s16vector_elements(*args, **kwargs):
  """pmt_s16vector_elements(pmt_t v) -> __dummy_20__"""
  return _gnuradio_core_runtime.pmt_s16vector_elements(*args, **kwargs)

def pmt_u32vector_elements(*args, **kwargs):
  """pmt_u32vector_elements(pmt_t v) -> __dummy_23__"""
  return _gnuradio_core_runtime.pmt_u32vector_elements(*args, **kwargs)

def pmt_s32vector_elements(*args, **kwargs):
  """pmt_s32vector_elements(pmt_t v) -> __dummy_22__"""
  return _gnuradio_core_runtime.pmt_s32vector_elements(*args, **kwargs)

def pmt_f32vector_elements(*args, **kwargs):
  """pmt_f32vector_elements(pmt_t v) -> __dummy_4__"""
  return _gnuradio_core_runtime.pmt_f32vector_elements(*args, **kwargs)

def pmt_f64vector_elements(*args, **kwargs):
  """pmt_f64vector_elements(pmt_t v) -> __dummy_5__"""
  return _gnuradio_core_runtime.pmt_f64vector_elements(*args, **kwargs)

def pmt_c32vector_elements(*args, **kwargs):
  """pmt_c32vector_elements(pmt_t v) -> __dummy_6__"""
  return _gnuradio_core_runtime.pmt_c32vector_elements(*args, **kwargs)

def pmt_c64vector_elements(*args, **kwargs):
  """pmt_c64vector_elements(pmt_t v) -> __dummy_27__"""
  return _gnuradio_core_runtime.pmt_c64vector_elements(*args, **kwargs)

def pmt_is_dict(*args, **kwargs):
  """pmt_is_dict(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_dict(*args, **kwargs)

def pmt_make_dict():
  """pmt_make_dict() -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_dict()

def pmt_dict_add(*args, **kwargs):
  """pmt_dict_add(pmt_t dict, pmt_t key, pmt_t value) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_add(*args, **kwargs)

def pmt_dict_delete(*args, **kwargs):
  """pmt_dict_delete(pmt_t dict, pmt_t key) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_delete(*args, **kwargs)

def pmt_dict_has_key(*args, **kwargs):
  """pmt_dict_has_key(pmt_t dict, pmt_t key) -> bool"""
  return _gnuradio_core_runtime.pmt_dict_has_key(*args, **kwargs)

def pmt_dict_ref(*args, **kwargs):
  """pmt_dict_ref(pmt_t dict, pmt_t key, pmt_t not_found) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_ref(*args, **kwargs)

def pmt_dict_items(*args, **kwargs):
  """pmt_dict_items(pmt_t dict) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_items(*args, **kwargs)

def pmt_dict_keys(*args, **kwargs):
  """pmt_dict_keys(pmt_t dict) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_keys(*args, **kwargs)

def pmt_dict_values(*args, **kwargs):
  """pmt_dict_values(pmt_t dict) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_dict_values(*args, **kwargs)

def pmt_is_any(*args, **kwargs):
  """pmt_is_any(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_any(*args, **kwargs)

def pmt_make_any(*args, **kwargs):
  """pmt_make_any(boost::any any) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_any(*args, **kwargs)

def pmt_any_ref(*args, **kwargs):
  """pmt_any_ref(pmt_t obj) -> boost::any"""
  return _gnuradio_core_runtime.pmt_any_ref(*args, **kwargs)

def pmt_any_set(*args, **kwargs):
  """pmt_any_set(pmt_t obj, boost::any any)"""
  return _gnuradio_core_runtime.pmt_any_set(*args, **kwargs)

def pmt_is_msg_accepter(*args, **kwargs):
  """pmt_is_msg_accepter(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_msg_accepter(*args, **kwargs)

def pmt_make_msg_accepter(*args, **kwargs):
  """pmt_make_msg_accepter(boost::shared_ptr<(gruel::msg_accepter)> ma) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_make_msg_accepter(*args, **kwargs)

def pmt_msg_accepter_ref(*args, **kwargs):
  """pmt_msg_accepter_ref(pmt_t obj) -> boost::shared_ptr<(gruel::msg_accepter)>"""
  return _gnuradio_core_runtime.pmt_msg_accepter_ref(*args, **kwargs)

def pmt_eq(*args, **kwargs):
  """pmt_eq(pmt_t x, pmt_t y) -> bool"""
  return _gnuradio_core_runtime.pmt_eq(*args, **kwargs)

def pmt_eqv(*args, **kwargs):
  """pmt_eqv(pmt_t x, pmt_t y) -> bool"""
  return _gnuradio_core_runtime.pmt_eqv(*args, **kwargs)

def pmt_equal(*args, **kwargs):
  """pmt_equal(pmt_t x, pmt_t y) -> bool"""
  return _gnuradio_core_runtime.pmt_equal(*args, **kwargs)

def pmt_length(*args, **kwargs):
  """pmt_length(pmt_t v) -> size_t"""
  return _gnuradio_core_runtime.pmt_length(*args, **kwargs)

def pmt_assq(*args, **kwargs):
  """pmt_assq(pmt_t obj, pmt_t alist) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_assq(*args, **kwargs)

def pmt_assv(*args, **kwargs):
  """pmt_assv(pmt_t obj, pmt_t alist) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_assv(*args, **kwargs)

def pmt_assoc(*args, **kwargs):
  """pmt_assoc(pmt_t obj, pmt_t alist) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_assoc(*args, **kwargs)

def pmt_map(*args, **kwargs):
  """pmt_map(pmt_t proc, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_map(*args, **kwargs)

def pmt_reverse(*args, **kwargs):
  """pmt_reverse(pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_reverse(*args, **kwargs)

def pmt_reverse_x(*args, **kwargs):
  """pmt_reverse_x(pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_reverse_x(*args, **kwargs)

def pmt_acons(*args, **kwargs):
  """pmt_acons(pmt_t x, pmt_t y, pmt_t a) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_acons(*args, **kwargs)

def pmt_nth(*args, **kwargs):
  """pmt_nth(size_t n, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_nth(*args, **kwargs)

def pmt_nthcdr(*args, **kwargs):
  """pmt_nthcdr(size_t n, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_nthcdr(*args, **kwargs)

def pmt_memq(*args, **kwargs):
  """pmt_memq(pmt_t obj, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_memq(*args, **kwargs)

def pmt_memv(*args, **kwargs):
  """pmt_memv(pmt_t obj, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_memv(*args, **kwargs)

def pmt_member(*args, **kwargs):
  """pmt_member(pmt_t obj, pmt_t list) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_member(*args, **kwargs)

def pmt_subsetp(*args, **kwargs):
  """pmt_subsetp(pmt_t list1, pmt_t list2) -> bool"""
  return _gnuradio_core_runtime.pmt_subsetp(*args, **kwargs)

def pmt_list1(*args, **kwargs):
  """pmt_list1(pmt_t x1) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list1(*args, **kwargs)

def pmt_list2(*args, **kwargs):
  """pmt_list2(pmt_t x1, pmt_t x2) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list2(*args, **kwargs)

def pmt_list3(*args, **kwargs):
  """pmt_list3(pmt_t x1, pmt_t x2, pmt_t x3) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list3(*args, **kwargs)

def pmt_list4(*args, **kwargs):
  """pmt_list4(pmt_t x1, pmt_t x2, pmt_t x3, pmt_t x4) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list4(*args, **kwargs)

def pmt_list5(*args, **kwargs):
  """pmt_list5(pmt_t x1, pmt_t x2, pmt_t x3, pmt_t x4, pmt_t x5) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list5(*args, **kwargs)

def pmt_list6(*args, **kwargs):
  """pmt_list6(pmt_t x1, pmt_t x2, pmt_t x3, pmt_t x4, pmt_t x5, pmt_t x6) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list6(*args, **kwargs)

def pmt_list_add(*args, **kwargs):
  """pmt_list_add(pmt_t list, pmt_t item) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list_add(*args, **kwargs)

def pmt_list_rm(*args, **kwargs):
  """pmt_list_rm(pmt_t list, pmt_t item) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_list_rm(*args, **kwargs)

def pmt_list_has(*args, **kwargs):
  """pmt_list_has(pmt_t list, pmt_t item) -> bool"""
  return _gnuradio_core_runtime.pmt_list_has(*args, **kwargs)

def pmt_is_eof_object(*args, **kwargs):
  """pmt_is_eof_object(pmt_t obj) -> bool"""
  return _gnuradio_core_runtime.pmt_is_eof_object(*args, **kwargs)

def pmt_read(*args, **kwargs):
  """pmt_read(std::istream port) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_read(*args, **kwargs)

def pmt_write(*args, **kwargs):
  """pmt_write(pmt_t obj, std::ostream port)"""
  return _gnuradio_core_runtime.pmt_write(*args, **kwargs)

def pmt_write_string(*args, **kwargs):
  """pmt_write_string(pmt_t obj) -> string"""
  return _gnuradio_core_runtime.pmt_write_string(*args, **kwargs)

def pmt_print(*args, **kwargs):
  """pmt_print(pmt_t v)"""
  return _gnuradio_core_runtime.pmt_print(*args, **kwargs)

def pmt_serialize(*args, **kwargs):
  """pmt_serialize(pmt_t obj, std::streambuf sink) -> bool"""
  return _gnuradio_core_runtime.pmt_serialize(*args, **kwargs)

def pmt_deserialize(*args, **kwargs):
  """pmt_deserialize(std::streambuf source) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_deserialize(*args, **kwargs)

def pmt_dump_sizeof():
  """pmt_dump_sizeof()"""
  return _gnuradio_core_runtime.pmt_dump_sizeof()

def pmt_serialize_str(*args, **kwargs):
  """pmt_serialize_str(pmt_t obj) -> string"""
  return _gnuradio_core_runtime.pmt_serialize_str(*args, **kwargs)

def pmt_deserialize_str(*args, **kwargs):
  """pmt_deserialize_str(string str) -> pmt_t"""
  return _gnuradio_core_runtime.pmt_deserialize_str(*args, **kwargs)
...
cvar = _gnuradio_core_runtime.cvar
PMT_T = cvar.PMT_T
PMT_F = cvar.PMT_F
...
def pmt_make_tuple(*args):
  """
    ...
    """
  return _gnuradio_core_runtime.pmt_make_tuple(*args)
...
class gr_basic_block(object):
    ...
    def symbol_name(self):
        """symbol_name(self) -> string"""
        return _gnuradio_core_runtime.gr_basic_block_symbol_name(self)
    ...
    def alias(self):
        """alias(self) -> string"""
        return _gnuradio_core_runtime.gr_basic_block_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(self, string name)"""
        return _gnuradio_core_runtime.gr_basic_block_set_block_alias(self, *args, **kwargs)
    ...
    def _post(self, *args, **kwargs):
        ...
        Accept msg, place in queue, arrange for thread to be awakened if it's not already.
        """
        return _gnuradio_core_runtime.gr_basic_block__post(self, *args, **kwargs)
    ...
    def message_ports_in(self):
        ...
        Returns the available input message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_basic_block_message_ports_in(self)
    ...
    def message_ports_out(self):
        ...
        Returns the available output message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_basic_block_message_ports_out(self)
...
class gr_block_sptr(object):
    ...
    def max_noutput_items(self):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_max_noutput_items(self)
    ...
    def set_max_noutput_items(self, *args, **kwargs):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_set_max_noutput_items(self, *args, **kwargs)
    ...
    def unset_max_noutput_items(self):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_unset_max_noutput_items(self)
    ...
    def is_set_max_noutput_items(self):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_is_set_max_noutput_items(self)
    ...
    def max_output_buffer(self, *args, **kwargs):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_max_output_buffer(self, *args, **kwargs)
    ...
    def set_max_output_buffer(self, *args):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_set_max_output_buffer(self, *args)
    ...
    def min_output_buffer(self, *args, **kwargs):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_min_output_buffer(self, *args, **kwargs)
    ...
    def set_min_output_buffer(self, *args):
        ...
        """
        return _gnuradio_core_runtime.gr_block_sptr_set_min_output_buffer(self, *args)
    ...
    def symbol_name(self):
        """symbol_name(self) -> string"""
        return _gnuradio_core_runtime.gr_block_sptr_symbol_name(self)
    ...
    def alias(self):
        """alias(self) -> string"""
        return _gnuradio_core_runtime.gr_block_sptr_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(self, string name)"""
        return _gnuradio_core_runtime.gr_block_sptr_set_block_alias(self, *args, **kwargs)
    ...
    def _post(self, *args, **kwargs):
        ...
        Accept msg, place in queue, arrange for thread to be awakened if it's not already.
        """
        return _gnuradio_core_runtime.gr_block_sptr__post(self, *args, **kwargs)
    ...
    def message_ports_in(self):
        ...
        Returns the available input message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_block_sptr_message_ports_in(self)
    ...
    def message_ports_out(self):
        ...
        Returns the available output message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_block_sptr_message_ports_out(self)
...
class gr_hier_block2_sptr(object):
    ...
    def primitive_msg_connect(self, *args):
        ...
        """
        return _gnuradio_core_runtime.gr_hier_block2_sptr_primitive_msg_connect(self, *args)
    ...
    def primitive_msg_disconnect(self, *args):
        ...
        primitive_msg_disconnect(self, gr_basic_block_sptr src, string srcport, gr_basic_block_sptr dst, 
            string dstport)
        """
        return _gnuradio_core_runtime.gr_hier_block2_sptr_primitive_msg_disconnect(self, *args)
    ...
    def primitive_message_port_register_hier_in(self, *args, **kwargs):
        ...
        return _gnuradio_core_runtime.gr_hier_block2_sptr_primitive_message_port_register_hier_in(self, *args, **kwargs)

    def primitive_message_port_register_hier_out(self, *args, **kwargs):
        """primitive_message_port_register_hier_out(self, pmt_t port_id)"""
        return _gnuradio_core_runtime.gr_hier_block2_sptr_primitive_message_port_register_hier_out(self, *args, **kwargs)
    ...
    def symbol_name(self):
        """symbol_name(self) -> string"""
        return _gnuradio_core_runtime.gr_hier_block2_sptr_symbol_name(self)
    ...
    def alias(self):
        """alias(self) -> string"""
        return _gnuradio_core_runtime.gr_hier_block2_sptr_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(self, string name)"""
        return _gnuradio_core_runtime.gr_hier_block2_sptr_set_block_alias(self, *args, **kwargs)
    ...
    def _post(self, *args, **kwargs):
        ...
        Accept msg, place in queue, arrange for thread to be awakened if it's not already.
        """
        return _gnuradio_core_runtime.gr_hier_block2_sptr__post(self, *args, **kwargs)
    ...
    def message_ports_in(self):
        ...
        Returns the available input message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_hier_block2_sptr_message_ports_in(self)
    ...
    def message_ports_out(self):
        ...
        Returns the available output message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_hier_block2_sptr_message_ports_out(self)
...
class gr_hier_block2(gr_basic_block):
    ...
    def primitive_msg_connect(self, *args):
        ...
        This adds (if not done earlier by another connect) a pair of gr-blocks or hierarchical blocks to the internal message port subscription
        """
        return _gnuradio_core_runtime.gr_hier_block2_primitive_msg_connect(self, *args)
    ...
    def primitive_msg_disconnect(self, *args):
        ...
        primitive_msg_disconnect(self, gr_basic_block_sptr src, string srcport, gr_basic_block_sptr dst, 
            string dstport)
        """
        return _gnuradio_core_runtime.gr_hier_block2_primitive_msg_disconnect(self, *args)
    ...
    def primitive_message_port_register_hier_in(self, *args, **kwargs):
        """primitive_message_port_register_hier_in(self, pmt_t port_id)"""
        return _gnuradio_core_runtime.gr_hier_block2_primitive_message_port_register_hier_in(self, *args, **kwargs)

    def primitive_message_port_register_hier_out(self, *args, **kwargs):
        """primitive_message_port_register_hier_out(self, pmt_t port_id)"""
        return _gnuradio_core_runtime.gr_hier_block2_primitive_message_port_register_hier_out(self, *args, **kwargs)
...
class gr_top_block_sptr(object):
    ...
    def primitive_msg_connect(self, *args):
        ...
        This adds (if not done earlier by another connect) a pair of gr-blocks or hierarchical blocks to the internal message port subscription
        """
        return _gnuradio_core_runtime.gr_top_block_sptr_primitive_msg_connect(self, *args)
    ...
    def primitive_msg_disconnect(self, *args):
        ...
        primitive_msg_disconnect(self, gr_basic_block_sptr src, string srcport, gr_basic_block_sptr dst, 
            string dstport)
        """
        return _gnuradio_core_runtime.gr_top_block_sptr_primitive_msg_disconnect(self, *args)
    ...
    def primitive_message_port_register_hier_in(self, *args, **kwargs):
        """primitive_message_port_register_hier_in(self, pmt_t port_id)"""
        return _gnuradio_core_runtime.gr_top_block_sptr_primitive_message_port_register_hier_in(self, *args, **kwargs)

    def primitive_message_port_register_hier_out(self, *args, **kwargs):
        """primitive_message_port_register_hier_out(self, pmt_t port_id)"""
        return _gnuradio_core_runtime.gr_top_block_sptr_primitive_message_port_register_hier_out(self, *args, **kwargs)
    ...
    def symbol_name(self):
        """symbol_name(self) -> string"""
        return _gnuradio_core_runtime.gr_top_block_sptr_symbol_name(self)
    ...
    def alias(self):
        """alias(self) -> string"""
        return _gnuradio_core_runtime.gr_top_block_sptr_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(self, string name)"""
        return _gnuradio_core_runtime.gr_top_block_sptr_set_block_alias(self, *args, **kwargs)
    ...
    def _post(self, *args, **kwargs):
        ...
        Accept msg, place in queue, arrange for thread to be awakened if it's not already.
        """
        return _gnuradio_core_runtime.gr_top_block_sptr__post(self, *args, **kwargs)
    ...
    def message_ports_in(self):
        ...
        Returns the available input message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_top_block_sptr_message_ports_in(self)
    ...
    def message_ports_out(self):
        ...
        Returns the available output message ports for a block. The return object is a PMT vector that is filled with PMT symbols.
        """
        return _gnuradio_core_runtime.gr_top_block_sptr_message_ports_out(self)
